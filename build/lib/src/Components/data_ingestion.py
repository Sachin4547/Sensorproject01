...
class DataIngestion:
    ...
    def initiate_data_ingestion(self) -> Path:
        ...
        logging.info("Entered initiated_data_injestion method of data_integration class")
        ...
        try:
            ...
            logging.info("excited initiated_data_ingestion method of data ingestion class")
